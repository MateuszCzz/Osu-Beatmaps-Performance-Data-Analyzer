...
A Google Colab data pipeline that mass-collects player score data from the osu! osu! API, processes tens of thousands of records, and surfaces maps which are statistically most rewarding for a specific rank bracket. This information is valuable - but that information doesn't exist anywhere officially. This pipeline builds it from scratch by scraping raw behavioral data at scale.
